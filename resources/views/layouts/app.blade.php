            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('daftar*') ? 'active' : '' }}" href="{{ route('daftar.index') }}"
                                aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('pasien*') ? 'active' : '' }}" href="{{ route('pasien.index') }}"
                                aria-expanded="false">
                                <span>
                                    <i class="ti ti-users"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('laporan-pasien') ? 'active' : '' }}"
                                href="{{ route('laporan-pasien.create') }}" aria-expanded="false">
                                <span>
                        ...
                        <a class="sidebar-link {{ request()->is('laporan-daftar') ? 'active' : '' }}"
                            href="{{ route('laporan-daftar.create') }}" aria-expanded="false">
                            <span>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="py-6 px-6 text-center">
                    <p class="mb-0 fs-4">Design and Developed by <a href="https://github.com/nurrafli" target="_blank"
                            class="pe-1 text-primary text-decoration-underline">Maudy Aulia Rizky</a></p>
                </div>
            </div>
        </div>
    </div>
